...
class UserInformUpdateScreenArgs {
  const UserInformUpdateScreenArgs({required this.updateType});

  final UpdateType updateType;
}

class UserInformUpdateScreen extends StatefulWidget {
  static const routeName = "user_inform_update";
  static const routeURL = "user_inform_update";
  const UserInformUpdateScreen({
    super.key,
  ...
  @override
  State<UserInformUpdateScreen> createState() => _UserInformUpdateScreenState();
}

class _UserInformUpdateScreenState extends State<UserInformUpdateScreen> {
